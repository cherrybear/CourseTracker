...
class block_course_status_tracker extends block_base {
 ...
 /*WWL- remove the last two lines from the block           $this->content->text .= get_string('inprogress_courses', 'block_course_status_tracker') . " : <b>" . $count_inprogress_courses . "</b><br>";
