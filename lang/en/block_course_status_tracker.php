 ...
 */
$string['pluginname'] = 'Module Status';
$string['course_status'] = 'Module Status';
$string['course_status_tracker'] = 'Module Status';
$string['s_no'] = ' <abbr title="number">No.</abbr>';
$string['course_name'] = 'Module Name';
$string['course_comp_date'] = 'Module Completion Date';
$string['grade'] = 'Grade';
$string['course_status_tracker:view'] = 'Module Status View';
$string['course_status_tracker:addinstance'] = 'Add Instance';
$string['enrolled_courses'] = 'Enrolled Modules';
$string['completed_courses'] = 'Completed Modules';
$string['inprogress_courses'] = 'Modules In Progress';
$string['undefined_coursecriteria'] = 'Undefined Module Criteria';
$string['coursecompletion_setting'] = 'Module Completion has not enable yet';
$string['job_title'] = 'Job Title';
$string['department'] = 'Department';
$string['joining_date'] = 'Joining Date';
$string['course'] = 'Module';
$string['report_coursecompletion'] = 'Module Completion Report';
